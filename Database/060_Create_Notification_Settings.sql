...
(
    ...
    FromDisplayName NVARCHAR(200) NOT NULL CONSTRAINT DF_NotificationSmtpSettings_FromDisplayName DEFAULT ('CHRONIQ Notifications'),
...
(
    ...
    NULL,
    NULL,
    'noreply@CHRONIQ.local',
    'CHRONIQ Notifications',
    1,
    NULL,
    SYSUTCDATETIME(),
    SYSUTCDATETIME()
